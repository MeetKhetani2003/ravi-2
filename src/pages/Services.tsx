        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 relative">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 text-lg text-ink-500 leading-relaxed max-w-2xl">
              From the first prenatal visit to your child's adolescent years — explore how Fateh blends world-class medicine with the warmth of home.
            </p>
          </div>
        </div>
      </section>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-5 rounded-[28px] bg-ink-900 text-white p-8 flex flex-col md:flex-row items-start md:items-center gap-6 justify-between">
                  ...
                  <Link to="/appointment" className="rounded-full bg-blush-500 text-white px-6 py-3 text-sm font-semibold hover:bg-blush-400 transition flex items-center gap-2 shrink-0">
