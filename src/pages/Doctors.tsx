        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 relative">
          <div className="max-w-3xl">
            ...
            <p className="mt-7 text-lg text-ink-500 leading-relaxed max-w-2xl">
              At Fateh, your doctor doesn't rotate every visit. Our team is small by design — senior, stable, and genuinely invested in the families they care for.
            </p>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="lg:col-span-7 p-8 lg:p-14">
                ...
                <div className="mt-8 grid md:grid-cols-5 gap-4 items-stretch">
                  ...
                  <Link
                    to="/appointment"
                    className="md:col-span-2 rounded-2xl bg-ink-900 text-white p-5 hover:bg-ink-800 transition flex flex-col justify-between"
                  >
                    <div>
                      <Calendar className="h-5 w-5 text-blush-400" />
                      <div className="mt-3 font-semibold">Book with {doc.name.split(' ')[0]}</div>
                      <div className="text-xs text-white/60 mt-1">Same-week slots available</div>
                    </div>
                    <ArrowUpRight className="h-5 w-5 text-blush-400 mt-3" />
                  </Link>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <Link to="/appointment" className="rounded-full bg-ink-900 text-white px-6 py-3.5 text-sm font-semibold hover:bg-ink-800 transition">
                  Book consultation
                </Link>
